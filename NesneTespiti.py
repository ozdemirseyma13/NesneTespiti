...
while True:#sonsuz döngü
    ...
    silah = silah_cascade.detectMultiScale(gray, 1.3,42, minSize=(100, 100))#silahların kordinat değerleri bulunur
    bicak= bicak_cascade.detectMultiScale(gray,1.3, 800)#bıçakların  kordinat değerleri bulunur
